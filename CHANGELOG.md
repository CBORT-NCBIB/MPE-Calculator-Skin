...
### Added
- ICNIRP 2013 skin MPE for all wavelength bands (180 nm to 1000 µm).
...
- Unit conversions (J/cm2, mJ/cm2, W/cm2, mW/cm2, pulse energy, average power).
- Test suite with 330 automated checks.
