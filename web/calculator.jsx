...
var _std = (typeof __STD_DATA__ !== "undefined") ? __STD_DATA__ : {"standard":{"name":"ICNIRP 2013","reference":"Health Phys. 105(3):271\u2013295","tables_used":"Tables 3, 5, 7","wl_range_nm":[180,1000000],"dur_range_s":[1e-9,30000]},"correction_factors":{"CA":{"default_outside_range":1,"regions":[{"wl_min_nm":400,"wl_max_nm":700,"type":"constant","value":1},{"wl_min_nm":700,"wl_max_nm":1050,"type":"power10","coefficient":0.002,"offset_nm":700},{"wl_min_nm":1050,"wl_max_nm":1400,"type":"constant","value":5}]}},"uv_discrete_steps":{"steps":[{"wl_upper_nm":303,"H_J_cm2":4e-3},{"wl_upper_nm":304,"H_J_cm2":6e-3},{"wl_upper_nm":305,"H_J_cm2":1e-2},{"wl_upper_nm":306,"H_J_cm2":1.6e-2},{"wl_upper_nm":307,"H_J_cm2":2.5e-2},{"wl_upper_nm":308,"H_J_cm2":4e-2},{"wl_upper_nm":309,"H_J_cm2":6.3e-2},{"wl_upper_nm":310,"H_J_cm2":1e-1},{"wl_upper_nm":311,"H_J_cm2":1.6e-1},{"wl_upper_nm":312,"H_J_cm2":2.5e-1},{"wl_upper_nm":313,"H_J_cm2":4e-1}],"fallback_H_J_cm2":6.3e-1},"display_bands":[{"name":"UV","wl_start_nm":180,"wl_end_nm":400},{"name":"Visible","wl_start_nm":400,"wl_end_nm":700},{"name":"Near-IR","wl_start_nm":700,"wl_end_nm":1400},{"name":"Far-IR","wl_start_nm":1400,"wl_end_nm":1000000}],"bands":[{"name":"UV","wl_min_nm":180,"wl_max_nm":400,"mode":"dual_limit","thermal":{"regions":[{"t_min_s":1e-9,"t_max_s":10,"formula":"power","a":0.56,"b":0.25}]},"photochemical":{"regions":[{"wl_min_nm":180,"wl_max_nm":302,"t_min_s":1e-9,"t_max_s":30000,"formula":"constant","a":3e-3},{"wl_min_nm":302,"wl_max_nm":315,"t_min_s":1e-9,"t_max_s":30000,"formula":"discrete","lookup":"uv_discrete_steps"},{"wl_min_nm":315,"wl_max_nm":400,"t_min_s":10,"t_max_s":30000,"formula":"constant","a":1,"below_t_min":"not_applicable"}]}},{"name":"Visible/Near-IR","wl_min_nm":400,"wl_max_nm":1400,"mode":"single","uses_ca":true,"regions":[{"t_min_s":1e-9,"t_max_s":1e-7,"formula":"ca_constant","a":0.02},{"t_min_s":1e-7,"t_max_s":10,"formula":"ca_power","a":1.1,"b":0.25},{"t_min_s":10,"t_max_s":30000,"formula":"ca_linear","a":0.2}]},{"name":"FIR 1400-1500","wl_min_nm":1400,"wl_max_nm":1500,"mode":"single","regions":[{"t_min_s":1e-9,"t_max_s":1e-3,"formula":"constant","a":0.1},{"t_min_s":1e-3,"t_max_s":10,"formula":"power","a":0.56,"b":0.25},{"t_min_s":10,"t_max_s":30000,"formula":"linear","a":0.1}]},{"name":"FIR 1500-1800","wl_min_nm":1500,"wl_max_nm":1800,"mode":"single","regions":[{"t_min_s":1e-9,"t_max_s":10,"formula":"constant","a":1},{"t_min_s":10,"t_max_s":30000,"formula":"linear","a":0.1}]},{"name":"FIR 1800-2600","wl_min_nm":1800,"wl_max_nm":2600,"mode":"single","regions":[{"t_min_s":1e-9,"t_max_s":1e-3,"formula":"constant","a":0.1},{"t_min_s":1e-3,"t_max_s":10,"formula":"power","a":0.56,"b":0.25},{"t_min_s":10,"t_max_s":30000,"formula":"linear","a":0.1}]},{"name":"FIR 2600-1mm","wl_min_nm":2600,"wl_max_nm":1000000,"mode":"single","regions":[{"t_min_s":1e-9,"t_max_s":1e-7,"formula":"constant","a":0.01},{"t_min_s":1e-7,"t_max_s":10,"formula":"power","a":0.56,"b":0.25},{"t_min_s":10,"t_max_s":30000,"formula":"linear","a":0.1}]}]};
          ...
          <div style={{padding:"12px 14px"}}>
            ...
            {r?<div style={{marginTop:12,paddingTop:10,borderTop:"1px solid "+T.bd}}>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12}}>
                <div><div style={{fontSize:9,fontWeight:600,textTransform:"uppercase",color:T.td,marginBottom:3}}>Per-Pulse MPE</div><div style={{fontSize:16,fontWeight:700,fontFamily:"monospace",color:T.ac}}>{si(r.effH,"J/cm\u00b2")}</div><div style={{fontSize:9,color:T.a2,marginTop:1}}>{STD_NAME+" table value"}</div>{isFinite(r.effH)?<div style={{fontSize:10,color:T.td,fontFamily:"monospace",marginTop:3}}>{"\u2261"} {si(r.effH*1e4,"J/m\u00b2")} <span style={{fontSize:8}}>(converted)</span></div>:null}</div>
  ...
  return (
    <div style={{minHeight:"100vh",background:T.bg,color:T.tx,fontFamily:"system-ui,-apple-system,sans-serif"}}>
      ...
      <div style={{padding:"16px 24px 40px",maxWidth:960,margin:"0 auto"}}>
        ...
        <div style={{textAlign:"center",fontSize:10,color:T.td,padding:"12px 0 4px",lineHeight:1.7,borderTop:"1px solid "+T.bd,marginTop:16}}>{STD_NAME} {"\u00b7"} {STD_REF} {"\u00b7"} {STD_TABLES}<br/>For research and educational purposes. Verify independently for safety-critical applications.</div>
      </div>
    </div>
  );
}
