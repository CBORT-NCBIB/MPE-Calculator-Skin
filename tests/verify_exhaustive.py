...
Hand-computes every expected value from ICNIRP 2013, ICNIRP Tables 5 and 7
...
Organization:
    ...
    Part 2: UV band (ICNIRP Tables 5 and 7, 180-400 nm) — thermal, photochemical, dual limit
    Part 3: 400-1400 nm (ICNIRP Tables 5 and 7) — every row, every boundary
    Part 4: 1400-1500 nm (ICNIRP 2013, Tables 5 and 7)
    Part 5: 1500-1800 nm (ICNIRP Tables 5 and 7)
    Part 6: 1800-2600 nm (ICNIRP Tables 5 and 7)
    Part 7: 2600-1000 um (ICNIRP Tables 5 and 7)
    Part 8: Wrapper dispatch at wavelength boundaries
    Part 9: Repetitive pulse (ICNIRP 2013, repetitive-pulse rules)
    Part 10: T_max (Table 4)
    Part 11: Limiting apertures (Table 8)
    Part 12: Large area (ICNIRP 2013, Table 7 note c)
    Part 13: UV de-rating (ICNIRP 2013, UV de-rating)
...
from laser_mpe.icnirp_skin import (
...
# --- Photochemical: 0.302-0.315: ICNIRP 2013 discrete 1-nm step values ---
...
for wl, expected in icnirp_uv_steps.items():
...
# 1e3 <= t < 3e4: ICNIRP 2013 keeps H = 1.0 constant (entire 10s to 30ks range)
...
# =================================================================
section("Part 3: 400-1400 nm (ICNIRP Tables 5 and 7)")
# =================================================================
...
# =================================================================
section("Part 4: 1400-1500 nm (ICNIRP 2013, Tables 5 and 7)")
# =================================================================
...
# =================================================================
section("Part 5: 1500-1800 nm (ICNIRP Tables 5 and 7)")
# =================================================================
...
# =================================================================
section("Part 6: 1800-2600 nm (ICNIRP Tables 5 and 7)")
# =================================================================
...
# =================================================================
section("Part 7: 2600-1000 um (ICNIRP Tables 5 and 7)")
# =================================================================
...
# =================================================================
section("Part 9: Repetitive pulse (ICNIRP 2013, repetitive-pulse rules)")
# =================================================================
...
# =================================================================
section("Part 12: Large area (ICNIRP 2013, Table 7 note c)")
# =================================================================
...
# =================================================================
section("Part 13: UV de-rating (ICNIRP 2013, UV de-rating)")
# =================================================================
