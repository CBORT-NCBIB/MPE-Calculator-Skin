...
References
----------
ICNIRP 2013, Section "Repetitive pulse exposures" (page 287).
"""

import numpy as np

from .icnirp_skin import H_skin_ICNIRP_MPE
...
def per_pulse_MPE(wl_nm, tau, f_array, T):
    ...
    """
    H_single = H_skin_ICNIRP_MPE(wl_nm, tau)
    H_total = H_skin_ICNIRP_MPE(wl_nm, T)
